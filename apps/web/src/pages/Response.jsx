  ...
  return (
    <div className="container my-5">
      ...
      <div className="alert alert-success text-center" role="alert">
        ...
        <p className="mb-2">
          Guarde este número. Você poderá acompanhar sua solicitação e enviar documentos com ele.
        </p>

        <p className="mb-0">
          📧 Enviamos o protocolo também para seu e-mail.
        </p>
      </div>
      ...
      <div className="card mt-4">
        <div className="card-header">
          <h5 className="card-title mb-0">Envie os arquivos clicando abaixo...</h5>
        </div>
